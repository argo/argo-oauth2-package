...
module.exports = function(handle) {
  ...
  handle('request', { affinity: 'sink' },function(env, next) {
    var woeid = env.route.params[1] ? env.route.params[1] : '2467861' /* Palo Alto, CA */;

    console.log('executing forecasts');
    //env.target.url = 'http://weather.yahooapis.com' + (env.request.url || '');
